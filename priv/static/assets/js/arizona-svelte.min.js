/*! Arizona Svelte v0.1.0 | Apache-2.0 License */
class he {
  /**
...
class de {
   ...
   */
  constructor(t = {}) {
    this.componentsDir = t.componentsDir || "../svelte/components", this.pattern = t.pattern || "*.svelte", this.registry = t.registry, this.componentModules = null;
  }
  /**
  ...
  async discoverComponents() {
    return this.componentModules = /* @__PURE__ */ Object.assign({}), this.componentModules;
  }
  /**
   ...
   */
  registerComponents(t = null) {
    const n = t || this.componentModules;
    if (!n)
      throw new Error("No components discovered. Run discoverComponents() first.");
    return Object.entries(n).forEach(([r, s]) => {
      const i = this.extractComponentName(r);
      this.registry.registerComponent(i, s.default);
    }), console.log(
      `[Arizona Svelte] Auto-discovered and registered ${Object.keys(n).length} components`
   ...
   */
  extractComponentName(t) {
    return t.split("/").pop().replace(".svelte", "");
  }
  /**
  ...
  async discoverAndRegister() {
    return await this.discoverComponents(), this.registerComponents();
  }
  /**
...
const jt = !1;
var qt = Array.isArray, ve = Array.prototype.indexOf, pe = Array.from, bt = Object.defineProperty, tt = Object.getOwnPropertyDescriptor, _e = Object.prototype, me = Array.prototype, ge = Object.getPrototypeOf, Ot = Object.isExtensible;
function ye(e) {
...
const T = 2, $t = 4, be = 8, Q = 16, Y = 32, B = 64, Mt = 128, k = 256, ht = 512, y = 1024, N = 2048, U = 4096, Z = 8192, it = 16384, Vt = 32768, Yt = 65536, Rt = 1 << 17, Ee = 1 << 18, mt = 1 << 19, Ce = 1 << 20, Et = 1 << 21, Bt = 1 << 22, dt = 1 << 23, yt = Symbol("$state"), Ht = new class extends Error {
...
let b = null, Ct = /* @__PURE__ */ new Set(), nt = [], xt = null, At = !1;
class O {
  /**
  ...
  process(t) {
    ...
    if (this.#s.length === 0 && this.#h === 0) {
      ...
      this.#t = [], this.#r = [], this.#l = [], b = null, Dt(n), Dt(r), b === null ? b = this : wt.delete(this), this.#o?.resolve();
    } else
  ...
  #u(t) {
    for (const n of t)
      ((n.f & N) !== 0 ? this.#c : this.#a).push(n), A(n, y);
    t.length = 0;
  }
  /**
  ...
  flush() {
    nt.length > 0 ? Fe() : this.#v(), b === this && (this.#h === 0 && wt.delete(this), this.deactivate());
  }
  /**
...
class qe {
  ...
  constructor(t, n, r) {
    ...
    _.b, this.#i = !!this.#o.pending, this.#s = Ze(() => {
      _.b = this;
      {
        try {
          this.#n = j(() => r(this.#e));
  ...
  #w() {
    ...
    t && (this.#t = j(() => t(this.#e)), O.enqueue(() => {
      this.#n = this.#p(() => (O.ensure(), j(() => this.#f(this.#e)))), this.#a > 0 ? this.#_() : (ct(
        /** @type {Effect} */
        this.#t,
        () => {
          this.#t = null;
  ...
  #_() {
    ...
    this.#n !== null && (this.#l = document.createDocumentFragment(), $e(this.#n, this.#l)), this.#t === null && (this.#t = j(() => t(this.#e)));
  }
  /**
  ...
  error(t) {
    ...
    const l = () => {
      ...
      s = !0, i && xe(), O.ensure(), this.#c = 0, this.#r !== null && ct(this.#r, () => {
        this.#r = null;
      }), this.#i = this.has_pending_snippet(), this.#n = this.#p(() => (this.#d = !1, j(() => this.#f(this.#e)))), this.#a > 0 ? this.#_() : this.#i = !1;
    };
    var a = p;
    try {
...
function Zt(e) {
  ...
  if (e.equals(t) || (e.v = t, e.wv = ue()), !lt) {
    var n = (F || (e.f & k) !== 0) && e.deps !== null ? U : y;
    A(e, n);
  }
}
...
function q(e, t, n = !1) {
  ...
  (!M || (p.f & Rt) !== 0) && Kt() && (p.f & (T | Q | Bt | Rt)) !== 0 && !R?.includes(e) && Te();
  let r = n ? X(t) : t;
  return Qt(e, r);
}
function Qt(e, t) {
  if (!e.equals(t)) {
    ...
    var r = O.ensure();
    r.capture(e, n), (e.f & T) !== 0 && ((e.f & N) !== 0 && Nt(
      /** @type {Derived} */
      e
    ), A(e, (e.f & k) === 0 ? y : U)), e.wv = ue(), Xt(e, N), _ !== null && (_.f & y) !== 0 && (_.f & (Y | B)) === 0 && (E === null ? nn([e]) : E.push(e));
  }
  return t;
}
function et(e) {
...
function X(e) {
  ...
  if (t !== _e && t !== me)
    return e;
  var n = /* @__PURE__ */ new Map(), r = qt(e), s = /* @__PURE__ */ z(0), i = V, l = (a) => {
    if (V === i)
      return a();
    var o = p, u = V;
    C(null), Pt(i);
    ...
    e,
    {
      ...
      get(a, o, u) {
        ...
        if (c === void 0 && (!d || tt(a, o)?.writable) && (c = l(() => {
          var f = X(d ? a[o] : g), v = /* @__PURE__ */ z(f);
          return v;
        }), n.set(o, c)), c !== void 0) {
          var h = W(c);
          return h === g ? void 0 : h;
      ...
      has(a, o) {
        ...
        if (u !== void 0 || _ !== null && (!c || tt(a, o)?.writable)) {
          u === void 0 && (u = l(() => {
            var h = c ? X(a[o]) : g, f = /* @__PURE__ */ z(h);
            return f;
          }), n.set(o, u));
          var d = W(u);
          if (d === g)
      ...
      set(a, o, u, c) {
        ...
        if (r && o === "length")
          ...
          d.v; f += 1) {
            var v = n.get(f + "");
            v !== void 0 ? q(v, g) : f in a && (v = l(() => /* @__PURE__ */ z(g)), n.set(f + "", v));
          }
        if (d === void 0)
          (!h || tt(a, o)?.writable) && (d = l(() => /* @__PURE__ */ z(void 0)), q(d, X(u)), n.set(o, d));
        else {
          h = d.v !== g;
          var S = l(() => X(u));
          q(d, S);
        ...
        if (ut?.set && ut.set.call(c, u), !h) {
          if (r && typeof o == "string") {
            ...
            Number.isInteger(L) && L >= at.v && q(at, L + 1);
          }
          et(s);
        }
        return !0;
...
function ot(e, t, n, r = !0) {
  ...
  if (r) {
    ...
    (l.f & mt) === 0 && (l = l.first), l !== null && (l.parent = s, s !== null && He(l, s), p !== null && (p.f & T) !== 0 && (e & B) === 0)) {
      var a = (
        /** @type {Derived} */
        p
      );
...
function x(e, t = !0) {
  var n = !1;
  (t || (e.f & Ee) !== 0) && e.nodes_start !== null && e.nodes_end !== null && (Xe(
    e.nodes_start,
    /** @type {TemplateNode} */
    e.nodes_end
  ), n = !0), se(e, t && !n), _t(e, 0), A(e, it);
  var r = e.transitions;
  if (r !== null)
    for (const i of r)
      i.stop();
...
function gt(e) {
  ...
  if ((t & U) !== 0) {
    ...
    if (n !== null) {
      var s, i, l = (t & ht) !== 0, a = r && _ !== null && !F, o = n.length;
      if ((l || a) && (_ === null || (_.f & it) === 0)) {
        ...
        l && (u.f ^= ht), a && c !== null && (c.f & k) === 0 && (u.f ^= k);
      }
      for (s = 0; s < o; s++)
        if (i = n[s], gt(
          /** @type {Derived} */
...
function fe(e) {
  var t = m, n = w, r = E, s = p, i = F, l = R, a = D, o = M, u = V, c = e.f;
  m = /** @type {null | Value[]} */
  null, w = 0, E = null, F = (c & k) !== 0 && (M || !G || p === null), p = (c & (Y | B)) === 0 ? e : null, R = null, vt(e.ctx), M = !1, V = ++st, e.ac !== null && (ne(() => {
    e.ac.abort(Ht);
  }), e.ac = null);
  try {
    e.f |= Et;
    ...
    if (m !== null) {
      var v;
      if (_t(e, w), f !== null && w > 0)
        for (f.length = w + m.length, v = 0; v < m.length; v++)
          f[w + v] = m[v];
      else
        e.deps = f = m;
      ...
      e.reactions !== null)
        for (v = w; v < f.length; v++)
          (f[v].reactions ??= []).push(e);
    } else f !== null && w < f.length && (_t(e, w), f.length = w);
    if (Kt() && E !== null && !M && f !== null && (e.f & (T | U | N)) === 0)
    ...
    e.f ^= Et, m = t, w = n, E = r, p = s, F = i, R = l, vt(a), M = o, V = u;
  }
}
function rn(e, t) {
  let n = t.reactions;
  ...
  (m === null || !m.includes(t)) && (A(t, U), (t.f & (k | ht)) === 0 && (t.f ^= ht), Jt(
    /** @type {Derived} **/
    t
  ), _t(
    /** @type {Derived} **/
...
function W(e) {
  ...
  if (p !== null && !M) {
    ...
    if (!r && !R?.includes(e)) {
      var s = p.deps;
      if ((p.f & Et) !== 0)
        e.rv < st && (e.rv = st, m === null && s !== null && s[w] === e ? w++ : m === null ? m = [e] : (!F || !m.includes(e)) && m.push(e));
      else {
        (p.deps ??= []).push(e);
        var i = e.reactions;
  ...
  if (lt) {
    ...
    if (n) {
      ...
      e;
      var o = l.v;
      return ((l.f & y) === 0 && l.reactions !== null || ce(l)) && (o = Nt(l)), P.set(l, o), o;
    }
...
const an = /* @__PURE__ */ new Set(), It = /* @__PURE__ */ new Set();
let Ut = null;
function ft(e) {
  var t = this, n = (
    /** @type {Node} */
...
function cn(e, { target: t, anchor: n, props: r = {}, events: s, context: i, intro: l = !0 }) {
  Ye();
  var a = /* @__PURE__ */ new Set(), o = (d) => {
    for (var h = 0; h < d.length; h++) {
      ...
      if (!a.has(f)) {
        ...
        var S = H.get(f);
        S === void 0 ? (document.addEventListener(f, ft, { passive: v }), H.set(f, 1)) : H.set(f, S + 1);
      }
    }
  };
  o(pe(an)), It.add(o);
  ...
  unmountComponent(t) {
    ...
    if (n)
      try {
        ...
        return hn(n), this.mountedComponents.delete(t), console.log(`[Arizona Svelte] 🗑️ Unmounted '${r}' component`, {
...
class pn {
   ...
   */
  constructor(t = {}) {
    this.registry = new he(), this.discovery = new de({
      registry: this.registry,
      componentsDir: t.componentsDir,
      pattern: t.pattern
    }), this.lifecycle = new dn(this.registry);
  }
  /**
   ...
   */
  async mountComponents() {
    return await this.init(), await this.lifecycle.mountComponents();
  }
  /**
   * Start automatic monitoring for component lifecycle
  ...
  async startMonitoring(t = {}) {
    await this.init(), this.lifecycle.updateMonitoringOptions(t), this.lifecycle.startMonitoring();
  }
  /**
   * Stop automatic monitoring
   * @returns {void}
