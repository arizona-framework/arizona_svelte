...
const T = 2, $t = 4, be = 8, Q = 16, Y = 32, B = 64, Mt = 128, N = 256, ht = 512, y = 1024, k = 2048, U = 4096, Z = 8192, it = 16384, Vt = 32768, Yt = 65536, Lt = 1 << 17, we = 1 << 18, mt = 1 << 19, Ee = 1 << 20, Et = 1 << 21, Bt = 1 << 22, dt = 1 << 23, yt = Symbol("$state"), Ht = new class extends Error {
...
class O {
  ...
  process(t) {
    ...
    if (this.#s.length === 0 && this.#h === 0) {
      ...
      this.#t = [], this.#r = [], this.#l = [], w = null, Rt(n), Rt(r), w === null ? w = this : bt.delete(this), this.#o?.resolve();
    } else
...
function j(e, t, n = !1) {
  ...
  (!M || (p.f & Lt) !== 0) && Kt() && (p.f & (T | Q | Bt | Lt)) !== 0 && !L?.includes(e) && Me();
  let r = n ? X(t) : t;
  return Qt(e, r);
}
function Qt(e, t) {
...
function fe(e) {
  var t = m, n = b, r = E, s = p, i = D, l = L, a = R, o = M, u = V, c = e.f;
  m = /** @type {null | Value[]} */
  null, b = 0, E = null, D = (c & N) !== 0 && (M || !G || p === null), p = (c & (Y | B)) === 0 ? e : null, L = null, vt(e.ctx), M = !1, V = ++st, e.ac !== null && (ne(() => {
    e.ac.abort(Ht);
  }), e.ac = null);
  try {
    e.f |= Et;
    ...
    e.f ^= Et, m = t, b = n, E = r, p = s, D = i, L = l, vt(a), M = o, V = u;
  }
}
function nn(e, t) {
  let n = t.reactions;
