...
export default defineConfig(({ mode }) => {
  ...
  return {
    ...
    build: {
      lib: {
        entry: 'assets/js/arizona-svelte.js',
        formats: ['es'],
        fileName: 'arizona-svelte',
      },
      ...
      emptyOutDir: false,
      rollupOptions: {
        input: 'assets/js/arizona-svelte.js',
        output: {
          format: 'es',
        ...
        plugins: [
          ...
          banner(() => {
            ...
            return `/*! Arizona Svelte v${pkg.version} | ${pkg.license} License */`;
          }),
